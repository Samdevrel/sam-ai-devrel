      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Explore modular blockchain architectures - execution, data availability, settlement, and consensus layers.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Understand modular architecture</li>
            <li>Compare different modular chains</li>
            <li>Analyze consensus models</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Modular architecture visualizations</li>
            <li>✓ Comparative analysis tools</li>
            <li>✓ Consensus model explanations</li>
            <li>✓ Performance metrics</li>
            <li>✓ Future roadmap tracking</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Explore different implementations</li>
            <li>Compare chain features</li>
            <li>Analyze consensus mechanisms</li>
          </ol>
        </section>
